...
import {addProduct, deleteProduct, getProductsByProductTypeAndUser, updateProduct} from "../../../action/ProductAction";

const Produits = ({getAllProductsType, productsType, products, getProductsByProductTypeAndUser, addProd, user, deleteProd, updateProd}) => {
    ...
    const handleChange = name => event => {
        if(name === "typeProduit" && event.target.value !== "0"){
            getProductsByProductTypeAndUser(parseInt(event.target.value));
        }
            ...
            <MaterialTable
                ...
                editable={{
                    onRowAdd: newData => new Promise(resolve => {
                        ...
                        getProductsByProductTypeAndUser(parseInt(state.typeProduit));
                        resolve();
                    }),
...
const mapDispatchToProps = (dispatch) => {
    return{
        ...
        getProductsByProductTypeAndUser: (idProductType) => dispatch(getProductsByProductTypeAndUser(idProductType)),
